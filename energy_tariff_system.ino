...
void loop(void) {
  ...
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 500 || sendDataPrevMillis == 0)) {
    ...
    // Firebase RTDB write
    if (Firebase.RTDB.setInt(&fbdo, "LED 1", count1) &&
        Firebase.RTDB.setInt(&fbdo, "LED 2", count2) &&
        Firebase.RTDB.setInt(&fbdo, "LED 3 ", count3) &&
        Firebase.RTDB.setInt(&fbdo, "LED 4", count4)) {
